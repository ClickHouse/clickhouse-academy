...
SELECT avg(fare_amount), avg(trip_distance) FROM $TABLE JOIN taxi_zone_lookup_opt4_2 ON pickup_location_id = taxi_zone_lookup_opt4_2.id WHERE taxi_zone_lookup_opt4_2.zone ILIKE '%airport%'
