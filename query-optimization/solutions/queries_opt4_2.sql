...
SELECT avg(fare_amount), avg(trip_distance) FROM taxi_zone_lookup_opt4_2 JOIN $TABLE ON pickup_location_id = taxi_zone_lookup_opt4_2.id WHERE taxi_zone_lookup_opt4_2.zone ILIKE '%airport%'
